...
TaskView.prototype = {
    ...
    createChildren: function () {
        ...
        return this; // allows for the method chaining inside the previous init() call
    },

    setupHandlers: function () {

        // setting up the event handlers and changing the scope of the this keyword inside that handler
